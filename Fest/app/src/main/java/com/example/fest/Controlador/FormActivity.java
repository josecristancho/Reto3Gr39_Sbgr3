package com.example.fest.Controlador;
...
public class FormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new MotorBaseDatosSQLite(getApplicationContext());
        ...
        if(name.equals("PRODUCTOS")){
            ...
            campo1.setHint("Location");
            campo2.setHint("Place");
            campo3.setHint("Phone");
